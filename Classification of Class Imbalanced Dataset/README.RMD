...
The project document file elaborately explains the process to build the classification model with high accuracy from a class imbalanced dataset.

The dataset.arff contains the input dataset
